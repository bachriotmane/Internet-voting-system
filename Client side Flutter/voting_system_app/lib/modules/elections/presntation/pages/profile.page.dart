...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> fetchUserInfo() async {
    ...
    try {
      final response =
          await _dio.get("${AppConstants.apiUrl}users/${loggedUser}");
      isLoading = false;
                    ...
                    child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            RowUserProfile(
                                info: "Email", value: userInfo.email),
                            RowUserProfile(
                                info: "Phone Number",
